...
func Load() (*Config, error) {
	...
	viper.SetDefault("APP_ENV", "development"); viper.SetDefault("APP_PORT", "8086")
	...
	viper.SetDefault("DB_NAME", "dealance_chat"); viper.SetDefault("DB_SSL_MODE", "disable")
	viper.SetDefault("REDIS_HOST", "localhost"); viper.SetDefault("REDIS_PORT", "6379")
	viper.SetDefault("REDIS_PASSWORD", ""); viper.SetDefault("REDIS_DB", 6)
